...
def training_loop(
    ...
    F_kwargs                = dnnlib.EasyDict(class_name='training.fewshot_adapt.Extra'),
    ...
    for module in [G, D, F, G_ema, augment_pipe]:
    ...
    loss = dnnlib.util.construct_class_by_name(device=device, G=G, D=D, F=F, augment_pipe=augment_pipe, **loss_kwargs) # subclass of training.loss.Loss
    ...
    for name, module, opt_kwargs, reg_interval in [('G', G, G_opt_kwargs, G_reg_interval), ('D', D, D_opt_kwargs, D_reg_interval)]:
        if reg_interval is None:
            ...
            parameters = list(module.parameters()) + list(F.parameters()) if name == 'D' else module.parameters()       
